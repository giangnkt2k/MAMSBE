...
export default {
    ...
    created() {
        ...
        this.getSelectedRolesInfo();
    },

    methods: {
        async getSelectedRolesInfo() {
            var response = await RequestApi.getOne({
                url: `${urlAPI.urlRoles}/${this.id}`,
            });
                    ...
                    .then((response) => {
                        if (response.code === 200) {
                            MakeToast({
                                variant: 'success',
                                title: 'Successfull',
                                content: 'Edit New Setting Successfull !',
                            });
                            this.returnToIndex();
                        }
                    })
